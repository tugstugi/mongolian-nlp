...
"""
Original source: https://github.com/pytorch/fairseq/blob/master/interactive.py
"""
...
def main(args):
    ...
    for inputs in buffered_read(args.buffer_size):
        ...
        indices = []
        results = []
        for batch, batch_indices in make_batches(prepared_inputs, args, task, max_positions):
